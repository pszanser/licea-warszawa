...
def main():
    ...
    with st.sidebar:
        ...
        use_ranking_filter = st.checkbox(
            "Filtruj według pozycji w rankingu liceów",
            value=False,
