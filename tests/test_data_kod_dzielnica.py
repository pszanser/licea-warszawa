...
def test_rows_from_page(mock_html_response):
    ...
    with patch('requests.get') as mock_get:
        ...
        mock_get.assert_called_once_with('https://www.kodypocztowe.info/warszawa', timeout=10)
...
def test_build_csv(tmp_path, monkeypatch):
    ...
    page_data = {
        ...
        2: [('00-002', 'Mokotów'), ('01-001', 'Wola')],  # Duplikat kodu 00-002, powinien być usunięty
        3: [('02-003', 'Praga')]
    }
